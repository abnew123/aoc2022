...
for(var l:I)if(j++<3|p){var x=l.split("\\D+");for(int y=6;y-->0;)q[y<3?y*3:y*2+1]=new Integer(x[y+2]);m=new int[]{x(x(q[0],q[3]),x(q[6],q[9])),q[7],q[11],t};d(t,1,0,0,0,0,0,0,z=0);r=p?r+new Integer(x[1])*z:r*z;}
return""+r;
}
void d(int t,int...s){
